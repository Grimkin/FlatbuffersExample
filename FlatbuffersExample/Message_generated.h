...
#ifndef Message_file_identifier
#define Message_file_identifier 0
#endif
/* deprecated, use Message_file_identifier */
#ifndef Message_identifier
#define Message_identifier 0
#endif
#define Message_type_hash ((flatbuffers_thash_t)0xae0ed984)
#define Message_type_identifier "\x84\xd9\x0e\xae"
#ifndef Message_file_extension
#define Message_file_extension "bin"
#endif
...
__flatbuffers_define_scalar_field(0, Message, timepoint, flatbuffers_double, double, 0.0000000000000000)
__flatbuffers_define_vector_field(1, Message, data, flatbuffers_int8_vec_t, 0)
...
__flatbuffers_build_table(flatbuffers_, Message, 2)

#define __Message_formal_args , double v0, flatbuffers_int8_vec_ref_t v1
#define __Message_call_args , v0, v1
static inline Message_ref_t Message_create(flatbuffers_builder_t *B __Message_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, Message, Message_file_identifier, Message_type_identifier)

__flatbuffers_build_scalar_field(0, flatbuffers_, Message_timepoint, flatbuffers_double, double, 8, 8, 0.0000000000000000, Message)
__flatbuffers_build_vector_field(1, flatbuffers_, Message_data, flatbuffers_int8, int8_t, Message)

static inline Message_ref_t Message_create(flatbuffers_builder_t *B __Message_formal_args)
{
    if (Message_start(B)
        || Message_timepoint_add(B, v0)
        || Message_data_add(B, v1)) {
        return 0;
    }
...
static Message_ref_t Message_clone(flatbuffers_builder_t *B, Message_table_t t)
{
    ...
    if (Message_start(B)
        || Message_timepoint_pick(B, t)
        || Message_data_pick(B, t)) {
        return 0;
    }
...
{
    int ret;
    if ((ret = flatcc_verify_field(td, 0, 8, 8) /* timepoint */)) return ret;
...
static inline int Message_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, Message_identifier, &Message_verify_table);
}
...
static inline int Message_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, Message_type_identifier, &Message_verify_table);
}
...
static inline int Message_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &Message_verify_table);
}
...
static inline int Message_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &Message_verify_table);
}
